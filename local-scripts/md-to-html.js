...
catMap.set('dsa', '<li class="bg-red-100 text-red-800 text-xs font-medium px-2 py-1 rounded-full">Data Structures & Algorithms</li>');
catMap.set('theory', '<li class="bg-green-100 text-green-800 text-xs font-medium px-2 py-1 rounded-full">Theory</li>');
...
catMap.set('systems', '<li class="bg-gray-200 text-gray-900 text-xs font-medium px-2 py-1 rounded-full">Systems</li>');
